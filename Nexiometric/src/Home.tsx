    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
      ...
      <div id="hero" className="container mx-auto px-6 pt-32 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Simplified container - removed expensive backdrop-blur and complex gradients */}
          <div className="relative bg-zinc-800/20 rounded-3xl border border-zinc-700/30 shadow-lg">
            {/* Simplified background - removed expensive radial gradient */}
      ...
      <div id="solution" className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative bg-zinc-800/20 rounded-3xl border border-zinc-700/30 shadow-lg p-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl bg-zinc-800/20 border border-zinc-700/20">
      ...
      <div id="demo" className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/demo/automati" 
              className="px-8 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-lg hover:from-teal-700 hover:to-cyan-700 transition-colors duration-200 text-lg text-center shadow-lg border border-teal-500/20"
            >
              Automati Dashboard
            </Link>
            <Link 
          ...
          <div className="relative bg-zinc-800/20 rounded-3xl border border-zinc-700/30 shadow-lg p-8">
            <div className="space-y-8">
              <div className="flex gap-6">
                <div className="text-2xl text-zinc-500 font-light">1</div>
                <div>
              ...
              <div className="flex gap-6">
                <div className="text-2xl text-zinc-500 font-light">2</div>
                <div>
              ...
              <div className="flex gap-6">
                <div className="text-2xl text-zinc-500 font-light">3</div>
                <div>
      ...
      <div id="cta" className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            ...
            className="inline-block px-8 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-lg hover:from-teal-700 hover:to-cyan-700 transition-colors duration-200 text-lg font-medium shadow-lg border border-teal-500/20"
          >
            Get Started
          </a>
          <p className="text-sm text-zinc-400 mt-6">
            A product of <a href="https://automatisolutions.com" className="text-teal-400 hover:text-teal-300 transition-colors duration-200">Automati Solutions</a>
          </p>
        </div>
      </div>
    </div>
